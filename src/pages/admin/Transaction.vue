            ...
            >
              ...
              <td class="py-3 px-6 text-center">
                <span class="font-semibold">{{
                  formatRupiah(invoice.total_cost)
                }}</span>
              </td>
              <td class="py-3 px-6 text-center">
                <div class="flex item-center justify-center">
                  <div
                    ...
                    @click="
                      $router.push(
                        `/admin/transaction-detail/${invoice.transaction_id}`
                      )
                    "
                  >
                    <svg
...
export default {
  ...
  setup() {
    ...
    const invoices = computed(() => store.state.product.invoice);
